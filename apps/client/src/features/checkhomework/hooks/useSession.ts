...
//   const [aiText, setAiText] = useState('ยอดเยี่ยมมาก! คุณตอบคำถามครบทุกข้อแล้ว กำลังประมวลผลคะแนนให้รอสักครู่...')
//   // const [sessionState, setSessionState] = useState<SessionState>('connecting')
//   const [sessionState, setSessionState] = useState<SessionState>('analyzing')
