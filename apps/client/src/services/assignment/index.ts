...
//   console.log('API_8000 URL:', process.env.NEXT_PUBLIC_API_8000)
...
//     '/api/assignments/regenerate-questions',
//     { filePdf, classroomId, creatorId },
//   )
// }
...
// upload ไฟล์ + generate คำถาม — ไม่ save DB
